                                ...
                                <div class="col-lg-5">
                                    <div class="card shadow-lg border-0 rounded-lg mt-5">
                                        <div class="card-header">
                                            <h3 class="text-center font-weight-light my-4"></h3>Alterar Senha
                                        </div>
                                        <div class="card-body">
                                            <form method="POST" action="alterarMesmoSenha.php">

                                                <div class="form-floating mb-3">
                                                    <input name="senhaAtual" class="form-control" id="inputFuncao" type="password" placeholder=" " required />
                                                    <label for="inputFuncao">Senha Atual</label>
                                                </div>
                                                <div class="form-floating mb-3">
                                                    <input name="senhaNova" class="form-control" id="inputFuncao" type="password" placeholder=" " required />
                                                    <label for="inputFuncao">Senha Nova</label>
                                                </div>
